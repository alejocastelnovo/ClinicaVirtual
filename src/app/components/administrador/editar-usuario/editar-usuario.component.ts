...
export class EditarUsuarioComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private especialidadesService: EspecialidadService, private dialogRef: MatDialogRef<EditarUsuarioComponent>, private usuarioService: UsuariosService, @Inject(MAT_DIALOG_DATA) public data: { id: any }, private router: Router) {
  ...
  guardar() {
    ...
    this.especialidadesService.crearMedicoEspecialidad(medicoEspecialidadBody).subscribe((data: any) => {
      if (data.codigo === 200) {
